...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/breathi3552/BreathScribe"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("BreathScribe/1.0 (+https://github.com/breathi3552/BreathScribe)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("BreathScribe"));
